...
from src.modules import Logger, Client
from loguru import logger
from src.modules.interfaces import SoftwareExceptionWithoutRetry
from src.utils.tools import helper, gas_checker
...
class Stargate(Logger):
    ...
    async def bridge(self, swapdata:dict):
        ...
        try:
            ...
            self.logger_msg(*self.client.acc_info, msg=f"Unexpected error: {str(e)}", type_msg='error')
